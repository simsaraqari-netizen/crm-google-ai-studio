...
--      ابوسارة  → 97335844  / password: 97335844
--      ابوحفني  → 66038736  / password: 66038736
--      ابوفارس  → 97335771  / password: 97335771
--      مروة    → 66899136  / password: 66899136
-- =============================================================
DO $$
DECLARE
  v_emp1_id uuid;
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp1_id, 'authenticated', 'authenticated',
     '97335844@realestate.com', crypt('97335844', gen_salt('bf')), NOW(), NOW(), NOW(),
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp2_id, 'authenticated', 'authenticated',
     '66038736@realestate.com', crypt('66038736', gen_salt('bf')), NOW(), NOW(), NOW(),
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp3_id, 'authenticated', 'authenticated',
     '97335771@realestate.com', crypt('97335771', gen_salt('bf')), NOW(), NOW(), NOW(),
    ...
    ('00000000-0000-0000-0000-000000000000', v_emp4_id, 'authenticated', 'authenticated',
     '66899136@realestate.com', crypt('66899136', gen_salt('bf')), NOW(), NOW(), NOW(),
